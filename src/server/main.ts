...
const webex = new WebexService(webexOAuth, webexClient, database);
...
const server = createApplicationServer(configuration, { publicDirectory, logger, webex, collections, scans, scheduler });
